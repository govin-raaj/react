  ...
  return (
    <div className='w-full px-6 md:px-20 sm:px-10 py-5 overflow-hidden flex flex-col gap-5 scroll-mt-20 mt-20 ' id='projects'>
      ...
      <div className='text-center mb-10'>
        <h1 className='font-extrabold md:text-5xl text-4xl  mb-3   hover:text-[#f9f495] duration-500'>Featured Projects</h1>
        <p className='max-w-xl mx-auto text-center md:text-lg text-[#fca311] '>A showcase of my work in artificial intelligence, machine learning, and full-stack development. Each project demonstrates practical applications of cutting-edge technologies.</p>
      </div>
