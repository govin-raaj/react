...
function Hero({
  ...
  return (
    <section className=" bg-linear-45 from-[#E2AB7F] to-[#C05850]  p-4 m-2 rounded-[10px] border-white border-3 overflow-hidden text-center "> 
...
// function Hero() {
//   return (
//     <section className="bg-gray-900 text-white px-6 py-20 text-center mx-2 my-2 rounded-lg max-[320px]:bg-amber-200">
...
//        className="mx-auto mt-5  rounded-full min-[320px]:w-25 min-[320px]:h-25 max-[320px]:w-10 max-[320px]:h-10 hover:scale-110" />
//        </a>
