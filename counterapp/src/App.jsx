...
function App() {
  ...
  return (
    <>
      <div className="min-h-screen w-full bg-gradient-to-b from-gray-900 to-gray-600 text-white relative overflow-hidden flex items-center justify-center" >

        <div className="bg-white p-6 rounded-xl  sm:w-[500px]">
